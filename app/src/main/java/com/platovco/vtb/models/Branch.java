...
public class Branch implements Serializable {
    ...
    public Branch(Long id, String name, String address, SortedMap<DayOfWeek, DaySchedule> dailyLoad, Double grade, Long amountOfReviews, Long load, Double x, Double y) {
        this.id = id;
        this.name = name;
